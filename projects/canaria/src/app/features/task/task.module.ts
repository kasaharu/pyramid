...
import { SectionListComponent } from './ui/section-list/section-list.component';
...
@NgModule({
  declarations: [TasksComponent, TaskListComponent, TaskItemComponent, TaskFormComponent, SectionListComponent],
